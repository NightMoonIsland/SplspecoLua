...
namespace Vm
{
    public class OpCode
    {
        ...
        public static readonly OpCode[] codes =
        {
            ...
            new OpCode(OpCodeEnum.OP_GETTABLE, 0, 1, OpArgMaskEnum.OpArgR, OpArgMaskEnum.OpArgK, OpModeEnum.iABC, InstructionsImplement.GetTable, ""),
            ...
            new OpCode(OpCodeEnum.OP_SETTABLE, 0, 1, OpArgMaskEnum.OpArgR, OpArgMaskEnum.OpArgK, OpModeEnum.iABC, InstructionsImplement.SetTable, ""),
            new OpCode(OpCodeEnum.OP_NEWTABLE, 0, 1, OpArgMaskEnum.OpArgR, OpArgMaskEnum.OpArgK, OpModeEnum.iABC, InstructionsImplement.NewTable, ""),
            new OpCode(OpCodeEnum.OP_SELF, 0, 1, OpArgMaskEnum.OpArgR, OpArgMaskEnum.OpArgK, OpModeEnum.iABC, InstructionsImplement.Self, ""),
            ...
            new OpCode(OpCodeEnum.OP_CALL, 0, 1, OpArgMaskEnum.OpArgR, OpArgMaskEnum.OpArgK, OpModeEnum.iABC, InstructionsImplement.Call, ""),
            ...
            new OpCode(OpCodeEnum.OP_SETLIST, 0, 1, OpArgMaskEnum.OpArgR, OpArgMaskEnum.OpArgK, OpModeEnum.iABC, InstructionsImplement.SetList, ""),
            new OpCode(OpCodeEnum.OP_CLOSURE, 0, 1, OpArgMaskEnum.OpArgR, OpArgMaskEnum.OpArgK, OpModeEnum.iABC, InstructionsImplement.Closure, ""),
            new OpCode(OpCodeEnum.OP_VARARG, 0, 1, OpArgMaskEnum.OpArgR, OpArgMaskEnum.OpArgK, OpModeEnum.iABC, InstructionsImplement.Vararg, ""),
